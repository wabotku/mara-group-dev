                ...
                <section className='naira-section'>
                    ...
                    <div className='content text-center'>
                        ...
                        <p className='deskripsi d-inline-grid' >
                           ...
                           <span> - Wedding Treatments ( Start from IDR 1,050,000,- ++ ) </span>
                        </p>
                        <h3 className='mt-5 mb-4'>Contact Us</h3>
                        <Row>
                            <Col md={6} style={{marginBottom:'30px'}}>
                                <a href='https://www.instagram.com/nairasalonandspa/' target={'_blank'} className='sosmed d-inline-grid'>
                                    <span><FontAwesomeIcon  icon={['fab', 'instagram']} size='3x'/></span>
                                    <span className='deskripsi'>@nairasalonandspa </span>
                                </a>
                            </Col>
                            <Col md={6}>
                                <a href='https://wa.me/6281392948123' target={'_blank'} className='sosmed d-inline-grid'>
